...
public class HttpExceptions {
    ...
    public static final int EXCEPTION_RESPONSE_UNKNOWN_CODE = 10002;
    /**
     Error that happens when the domain can't be resolved: wrong name or there is no internet connection.
     */
    public static final int EXCEPTION_UNKNOWN_HOST_CODE = 10003;
    public static final int EXCEPTION_CONNECT_TIMEOUT_CODE = 10004;
    public static final int EXCEPTION_REQUEST_TIMEOUT_CODE = 10005;
    ...
    public static Function<Throwable, HttpException> EXCEPTION_READING_BODY_RESPONSE =
            exc -> new HttpException(EXCEPTION_READING_BODY_RESPONSE_CODE,
                                     exc);
            ...
            exc -> {
                switch (exc.getClass()
                    ...
                    case "ConnectTimeoutException": {
                        return new HttpException(EXCEPTION_CONNECT_TIMEOUT_CODE,
                                                 exc
                        );
                    }
                    case "UnknownHostException": {
                        return new HttpException(EXCEPTION_UNKNOWN_HOST_CODE,
                                                 exc
                        );
                    }
                    case "NoStackTraceTimeoutException": {
                        return new HttpException(EXCEPTION_REQUEST_TIMEOUT_CODE,
                                                 exc
                        );

                    }
                    default:
                        return new HttpException(EXCEPTION_RESPONSE_UNKNOWN_CODE,
                                                 exc
                        );
                }
            };
