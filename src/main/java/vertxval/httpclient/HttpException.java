...
public class HttpException extends ReplyException {
    ...
    public static final int UNKNOWN_RESPONSE_CODE = 10001;
    /**
     Error that happens when the domain can't be resolved: wrong name or there is no internet connection.
     */
    public static final int UNKNOWN_HOST_CODE = 10002;
    public static final int CONNECT_TIMEOUT_CODE = 10003;
    public static final int REQUEST_TIMEOUT_CODE = 10004;
