...
class AggregateActors {
    ...
    protected <O> Supplier<Function<JsArray, Future<O>>> spawnAggregate(final DeploymentOptions deploymentOptions,
                                                                        final Function<AggregateIterable<JsObj>, O> resultConverter) {
        requireNonNull(resultConverter);
    ...
    protected <O> Supplier<Function<JsArray, Future<O>>> spawnAggregate(final Function<AggregateIterable<JsObj>, O> resultConverter) {
        requireNonNull(resultConverter);
