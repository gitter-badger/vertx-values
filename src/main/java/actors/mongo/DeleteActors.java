...
class DeleteActors {
  ...
  public <O> Supplier<Function<JsObj, Future<O>>> spawnDeleteOne(final DeleteOptions options,
                                                                 final DeploymentOptions deploymentOptions,
                                                                 final Function<DeleteResult,O> resultConverter){
    requireNonNull(options);
    Function<JsObj,O> deleteOne = filter -> {
  ...
  public <O> Supplier<Function<JsObj, Future<O>>> spawnDeleteOne(final Function<DeleteResult,O> resultConverter){
    Function<JsObj,O> delete = filter -> {
      MongoCollection<JsObj> collection = requireNonNull(this.collection.get());
  ...
  public <O> Supplier<Function<JsObj, Future<O>>> spawnDeleteMany(final DeleteOptions options,
                                                                  final DeploymentOptions deploymentOptions,
                                                                  final Function<DeleteResult,O> resultConverter){
    requireNonNull(options);
    Function<JsObj,O> deleteOne = filter -> {
  ...
  public <O> Supplier<Function<JsObj, Future<O>>> spawnDeleteMany(final Function<DeleteResult,O> resultConverter){
    Function<JsObj,O> delete = filter -> {
      MongoCollection<JsObj> collection = requireNonNull(this.collection.get());
