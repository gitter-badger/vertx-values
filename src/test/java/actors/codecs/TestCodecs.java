...
public class TestCodecs {
    ...
    public void testJsObjCodec(){
        ...
        JsObjGen gen = JsObjGen.of("a",
                                   JsGens.alphabetic.nullable().optional(),
                                   "b",
                                   JsGens.longInteger.nullable(),
                                   "c",
                                   JsGens.integer.nullable().optional(),
                                   "d",
                                   JsGens.bool.nullable(),
                                   "e",
                                   JsGens.dateBetween(0, 10_000).nullable().optional(),
                                   "f",
                                   JsGens.array(JsGens.integer,10).nullable(),
                                   "g",
                                   JsObjGen.of("a",JsGens.oneOf(JsObj.empty())).nullable()
                                   );
        ...
        TestProperty.test(gen,objEncondingProperty,100);
        TestProperty.test(JsGens.array(gen,10),arrEncondingProperty,100);
    }
